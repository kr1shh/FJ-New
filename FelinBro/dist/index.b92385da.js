/* ========================================scroll up btn==================================== */ document.addEventListener("DOMContentLoaded", function() {
    ...
    function toggleScrollButton() {
        ...
        } else scrollUpButton.style.opacity = "0";
...
/* ==================================Logo scroll up========================== */ document.addEventListener("DOMContentLoaded", function() {
    var linkUp = document.getElementById("link-up");
    linkUp.addEventListener("click", function(event) {
        event.preventDefault();
        if (isHomePage()) window.scrollTo({
            top: 0,
            behavior: "smooth"
        });
...
//# sourceMappingURL=index.b92385da.js.map
